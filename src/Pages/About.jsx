  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <Helmet>
          <title>About the Toolz Hub | Free Online Tools</title>
          <meta
            name="description"
            content="Learn more about the Toolz Hub, a platform offering fast, free, browser-based online tools with no sign-up required."
          /> 
        </Helmet>
        ...
        <div className="space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-slate-900 mb-3">
              What is the Toolz Hub?
            </h2>
            <p>
              the Toolz Hub is a collection of fast, simple, and free
          ...
          <section>
            ...
            <p>
              the Toolz Hub is built for anyone who needs quick answers or
          ...
          <section>
            ...
            <p>
              the Toolz Hub does not require accounts or collect personal
